...
## a. initial height predicted by rehydrate height and/or species

This section includes code to fit linear mixed effect models to answer the question: how do rehydrated trait values predict initial trait values? Each trait is predicted by two models: (describe model differences). We view model summaries using `summary()`.
