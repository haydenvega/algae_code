...
thick_ih_predictions_species <- ggpredict(c(thick_reg_ih, terms = c("thick_h", "species")),  %>% 
  as_tibble() %>% 
  rename(species = group)
...
plot_frame <- as_tibble(surf_ir_predictions)
new_frame <- as_tibble(perimeter_ir_predictions)
...
updated <- rbind(plot_frame, new_frame, thick_ir_predictions)
